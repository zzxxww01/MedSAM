...
3. 当前阶段判断：
   ...
   - Loss 主干已锁定 A3R3；
   - Attention 阶段可直接启动，并以 A3R3 作为固定损失底座。
...
6. 以 A3R3 为固定主干后，Attention 阶段具备可解释的控制变量前提。
...
满足任一条件时更新本报告：
1. B1（Attention 模块独立验证）指标产出并回填；
2. C1（Attention + A3R3）指标产出并回填；
3. 第4章实验表首次定稿；
4. 第5章综合实验新增对比结果；
5. 论文第3/4章联动前需要“结果-叙事”一致性复核。

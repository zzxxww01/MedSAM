...
| **C2** | A3R3 Balance + LoRA (rank=4) | CT_Abd | 0.879610 | 7.754797 | 0.996511 | 出乎意料退化 | 相比 A0/A3R3 大幅下降。即使修复了 Eval 验证加载问题，单靠秩为 4 的 LoRA 无法在这 40 例数据中捕捉到足够的全局信息，反而因为冻结了 Encoder 并限制了更新能力，导致严重欠拟合。 |
